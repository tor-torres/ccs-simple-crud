...
<?php
$query = $DB->query("SELECT * FROM image_carousel_table WHERE id = {$_GET['id']}");
...
<div class="container">
    ...
    <form method="POST">
        <input type="hidden" name="action" value="update_image_carousel">
        <div class="row">
            <div class="col-12">
                <div class="form-group my-2">
                    <label for="image">Image:</label>
                    <input type="file" name="image" id="image" class="form-control pb-4">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="d-flex justify-content-end pt-3">    
            <a href="?page=image-carousel" class="btn btn-secondary mx-3">Cancel</a>
